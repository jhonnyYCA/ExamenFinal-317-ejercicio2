...
package exa.ejercicio2excel_0_1;
...
/**
 * Job: ejercicio2Excel Purpose: ejercicio2(excel)<br>
 * Description: ejercicio2(excel) <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class ejercicio2Excel implements TalendJob {
	...
	private final String jobName = "ejercicio2Excel";
	private final String projectName = "EXA";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					ejercicio2Excel.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ejercicio2Excel.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_EXA_ejercicio2Excel = new byte[0];
		static byte[] commonByteArray_EXA_ejercicio2Excel = new byte[0];
		...
		public Character nombre;

		public Character getNombre() {
			return this.nombre;
		}

		public Character apellido;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_EXA_ejercicio2Excel) {
		...
		public String toString() {
			...
			sb.append(",apellido=" + String.valueOf(apellido));
			sb.append("]");
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.setTableName("alumno");
				util_tLogRow_1.addRow(new String[] { "id", "nombre", "apellido", });
...
///////////////////////    			
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:FudgLVzBKDWXByonU73gHZxDmBVZP1FBemP/fg==");
				...
				Object source_tFileInputExcel_1 = "D:/academicos.xlsx";
				...
				try {
					...
					sheetList_tFileInputExcel_1
							.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "alumno", false));
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.nombre = ParserUtils.parseTo_Character(
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.apellido = ParserUtils.parseTo_Character(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1]);
								} else {
									row1.apellido = null;
									emptyColumnCount_tFileInputExcel_1++;
...
///////////////////////		
								...
								if (row1.nombre != null) { //
									row_tLogRow_1[1] = String.valueOf(row1.nombre);

								} //

								if (row1.apellido != null) { //
									row_tLogRow_1[2] = String.valueOf(row1.apellido);
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_EXA_ejercicio2Excel.length) {
					if (length < 1024 && commonByteArray_EXA_ejercicio2Excel.length == 0) {
						commonByteArray_EXA_ejercicio2Excel = new byte[1024];
					} else {
						commonByteArray_EXA_ejercicio2Excel = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_EXA_ejercicio2Excel, 0, length);
				strReturn = new String(commonByteArray_EXA_ejercicio2Excel, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_EXA_ejercicio2Excel, 0, length);
				strReturn = new String(commonByteArray_EXA_ejercicio2Excel, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_EXA_ejercicio2Excel) {
				...
				try {
					...
					this.ci = readInteger(dis);

					this.correo = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.ci, dos);

				// String

				writeString(this.correo, dos);
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("ci=" + String.valueOf(ci));
	...
	public void tFileInputExcel_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_2.setTableName("correos");
				util_tLogRow_2.addRow(new String[] { "ci", "correo", });
...
///////////////////////    			
				...
				final String decryptedPassword_tFileInputExcel_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:wCnmeOfxSR6O56KDUJ21DoCkvprnfiMDXDOyIg==");
				...
				Object source_tFileInputExcel_2 = "D:/academicos.xlsx";
				...
				try {
					...
					sheetList_tFileInputExcel_2.addAll(
							regexUtil_tFileInputExcel_2.getSheets(workbook_tFileInputExcel_2, "alumnos_correo", false));
						...
						for (int i_tFileInputExcel_2 = begin_line_tFileInputExcel_2; i_tFileInputExcel_2 < end_line_tFileInputExcel_2; i_tFileInputExcel_2++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
									...
									curColName_tFileInputExcel_2 = "ci";

									row2.ci = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
								...
								if (temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
									curColNum_tFileInputExcel_2 = columnIndex_tFileInputExcel_2
											+ start_column_tFileInputExcel_2 + 1;
									curColName_tFileInputExcel_2 = "correo";

									row2.correo = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
								} else {
									row2.correo = null;
									emptyColumnCount_tFileInputExcel_2++;
								}
...
///////////////////////		
								...
								if (row2.ci != null) { //
									row_tLogRow_2[0] = String.valueOf(row2.ci);

								} //

								if (row2.correo != null) { //
									row_tLogRow_2[1] = String.valueOf(row2.correo);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final ejercicio2Excel ejercicio2ExcelClass = new ejercicio2Excel();

		int exitCode = ejercicio2ExcelClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ejercicio2Excel.class.getClassLoader()
					.getResourceAsStream("exa/ejercicio2excel_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ejercicio2Excel.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : ejercicio2Excel");
		}
...
/************************************************************************************************
 * 82979 characters generated by Talend Open Studio for Data Integration on the
 * 13 de diciembre de 2022, 12:33:05 VET
 ************************************************************************************************/